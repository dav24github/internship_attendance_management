                ...
                <div class="card">
                            ...
                            <table class="table table-striped table-md">
                                <tbody>
                                    ...
                                    <tr v-for="(falta, index) in faltas.data">
                                        ...
                                        <td>
                                            {{
                                                fecha_formato(falta.falta_fecha)
                                            }}
                                        </td>
                                        <td>{{ falta.nombre }}</td>
                                        <td v-if="falta.hr_entrada">
                                            {{ falta.hr_entrada }}
                                        </td>
                                        <td v-else>--:--</td>
                                        <td>--:--</td>
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            <page-number
                                :data="faltas"
                                @pagination-change-page="allFalta"
                            ></page-number>
                        </nav>
                    </div>
                </div>
