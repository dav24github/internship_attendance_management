                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <div>
                                <router-link
                                    :to="{ name: 'practicanteCreate' }"
                                    class="btn btn-success"
                                    >Nuevo practicante</router-link
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer text-right">
                        <nav class="d-inline-block">
                            <page-number
                                :data="practicantes"
                                @pagination-change-page="allPracticante"
                            ></page-number>
                        </nav>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        allPracticante(page) {
            axios
                .get("api/practicantes?page=" + page)
                .then((res) => {
    ...
    created() {
        Fire.$on("searching", () => {
            ...
            axios
                .get("api/findPracticante?q=" + query)
                .then((data) => {
